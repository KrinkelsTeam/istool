...
void CMainFrame::SetSection(UINT nID) {
	if (m_wndView.m_hWnd) {
		...
		case 17: m_wndCompileStepPre.DestroyView(); break;
		case 18: m_wndCompileStepPost.DestroyView(); break;
		case 19: m_wndDownload.DestroyView(); break;
		case 20: m_wndLanguages.DestroyView(); break;
