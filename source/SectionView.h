...
public:
	...
	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled) {
		...
		HIMAGELIST hImageList = ImageList_LoadImage(_Module.GetResourceInstance(), MAKEINTRESOURCE(IDB_SECTIONS), 16, 1, CLR_NONE, IMAGE_BITMAP, LR_CREATEDIBSECTION | LR_DEFAULTSIZE);
	...
	void InsertHeader(LPCTSTR pszHeader) {
		m_hRoot = baseClass::InsertItem(pszHeader, 18, 18, TVI_ROOT, TVI_LAST);
