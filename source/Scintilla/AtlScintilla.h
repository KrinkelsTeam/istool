...
// Attributes
	...
	intptr_t GetLength() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETLENGTH, (WPARAM)0, (LPARAM)0);
	}

	/// Returns the character byte at the position.
	int GetCharAt(intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t GetCurrentPos() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETCURRENTPOS, (WPARAM)0, (LPARAM)0);
	}

	/// Returns the position of the opposite end of the selection to the caret.
	intptr_t GetAnchor() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETANCHOR, (WPARAM)0, (LPARAM)0);
	}

	/// Returns the style byte at the position.
	int GetStyleAt(intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (int)::SendMessage(m_hWnd, SCI_GETSTYLEAT, (WPARAM)pos, (LPARAM)0);
	}

	/// Returns the unsigned style byte at the position.
	int GetStyleIndexAt(intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t GetStyledText(Sci_TextRange* tr) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSTYLEDTEXT, (WPARAM)0, (LPARAM)tr);
	}

	/// Retrieve a buffer of cells that can be past 2GB.
	/// Returns the number of bytes in the buffer not including terminating NULs.
	intptr_t GetStyledTextFull(Sci_TextRangeFull* tr) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSTYLEDTEXTFULL, (WPARAM)0, (LPARAM)tr);
	}
	...
	intptr_t MarkerLineFromHandle(int markerHandle) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_MARKERLINEFROMHANDLE, (WPARAM)markerHandle, (LPARAM)0);
	}
	...
	intptr_t PositionFromPoint(int x, int y) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_POSITIONFROMPOINT, (WPARAM)x, (LPARAM)y);
	}
	...
	intptr_t PositionFromPointClose(int x, int y) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_POSITIONFROMPOINTCLOSE, (WPARAM)x, (LPARAM)y);
	}
	...
	intptr_t GetCurLine(intptr_t length, char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETCURLINE, (WPARAM)length, (LPARAM)text);
	}

	/// Retrieve the position of the last correctly styled character.
	intptr_t GetEndStyled() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETENDSTYLED, (WPARAM)0, (LPARAM)0);
	}
	...
	int GetNextTabStop(intptr_t line, int x) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	int MarkerAdd(intptr_t line, int markerNumber) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t MarkerNext(intptr_t lineStart, int markerMask) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_MARKERNEXT, (WPARAM)lineStart, (LPARAM)markerMask);
	}

	/// Find the previous line before lineStart that includes a marker in mask.
	intptr_t MarkerPrevious(intptr_t lineStart, int markerMask) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_MARKERPREVIOUS, (WPARAM)lineStart, (LPARAM)markerMask);
	}
	...
	void SetStylingEx(intptr_t length, const char* styles) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	void PushUndoActionType(int type, intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	void ChangeLastUndoActionText(intptr_t length, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t GetUndoActionPosition(int action) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETUNDOACTIONPOSITION, (WPARAM)action, (LPARAM)0);
	}

	/// What is the text of an action?
	int GetUndoActionText(int action, char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	void AutoCShow(intptr_t lengthEntered, const char* itemList) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t AutoCPosStart() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_AUTOCPOSSTART, (WPARAM)0, (LPARAM)0);
	}
	...
	int GetLineIndentation(intptr_t line) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t GetLineIndentPosition(intptr_t line) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETLINEINDENTPOSITION, (WPARAM)line, (LPARAM)0);
	}

	/// Retrieve the column number of a position, taking tab width into account.
	intptr_t GetColumn(intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETCOLUMN, (WPARAM)pos, (LPARAM)0);
	}

	/// Count characters between two positions.
	intptr_t CountCharacters(intptr_t start, intptr_t end) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_COUNTCHARACTERS, (WPARAM)start, (LPARAM)end);
	}

	/// Count code units between two positions.
	intptr_t CountCodeUnits(intptr_t start, intptr_t end) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_COUNTCODEUNITS, (WPARAM)start, (LPARAM)end);
	}
	...
	intptr_t GetHighlightGuide() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETHIGHLIGHTGUIDE, (WPARAM)0, (LPARAM)0);
	}

	/// Get the position after the last visible characters on a line.
	intptr_t GetLineEndPosition(intptr_t line) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETLINEENDPOSITION, (WPARAM)line, (LPARAM)0);
	}
	...
	intptr_t GetSelectionStart() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONSTART, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t GetSelectionEnd() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONEND, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t FindText(int searchFlags, Sci_TextToFind* ft) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_FINDTEXT, (WPARAM)searchFlags, (LPARAM)ft);
	}

	/// Find some text in the document.
	intptr_t FindTextFull(int searchFlags, Sci_TextToFindFull* ft) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_FINDTEXTFULL, (WPARAM)searchFlags, (LPARAM)ft);
	}

	/// Draw the document into a display context such as a printer.
	intptr_t FormatRange(bool draw, Sci_RangeToFormat* fr) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_FORMATRANGE, (WPARAM)draw, (LPARAM)fr);
	}

	/// Draw the document into a display context such as a printer.
	intptr_t FormatRangeFull(bool draw, Sci_RangeToFormatFull* fr) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_FORMATRANGEFULL, (WPARAM)draw, (LPARAM)fr);
	}
	...
	intptr_t GetSelectionSerialized(char* selectionString) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONSERIALIZED, (WPARAM)0, (LPARAM)selectionString);
	}

	/// Retrieve the display line at the top of the display.
	intptr_t GetFirstVisibleLine() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETFIRSTVISIBLELINE, (WPARAM)0, (LPARAM)0);
	}

	/// Retrieve the contents of a line.
	/// Returns the length of the line.
	intptr_t GetLine(intptr_t line, char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETLINE, (WPARAM)line, (LPARAM)text);
	}

	/// Returns the number of lines in the document. There is always at least one.
	intptr_t GetLineCount() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETLINECOUNT, (WPARAM)0, (LPARAM)0);
	}
	...
	/// Result is NUL-terminated.
	intptr_t GetSelText(char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELTEXT, (WPARAM)0, (LPARAM)text);
	}

	/// Retrieve a range of text.
	/// Return the length of the text.
	intptr_t GetTextRange(Sci_TextRange* tr) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETTEXTRANGE, (WPARAM)0, (LPARAM)tr);
	}

	/// Retrieve a range of text that can be past 2GB.
	/// Return the length of the text.
	intptr_t GetTextRangeFull(Sci_TextRangeFull* tr) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETTEXTRANGEFULL, (WPARAM)0, (LPARAM)tr);
	}
	...
	intptr_t LineFromPosition(intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_LINEFROMPOSITION, (WPARAM)pos, (LPARAM)0);
	}

	/// Retrieve the position at the start of a line.
	intptr_t PositionFromLine(intptr_t line) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_POSITIONFROMLINE, (WPARAM)line, (LPARAM)0);
	}
	...
	/// Result is NUL-terminated.
	intptr_t GetText(intptr_t length, char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETTEXT, (WPARAM)length, (LPARAM)text);
	}

	/// Retrieve the number of characters in the document.
	intptr_t GetTextLength() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETTEXTLENGTH, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t GetTargetStart() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETTARGETSTART, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t GetTargetStartVirtualSpace() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETTARGETSTARTVIRTUALSPACE, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t GetTargetEnd() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETTARGETEND, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t GetTargetEndVirtualSpace() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETTARGETENDVIRTUALSPACE, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t GetTargetText(char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETTARGETTEXT, (WPARAM)0, (LPARAM)text);
	}
	...
	intptr_t ReplaceTarget(intptr_t length, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_REPLACETARGET, (WPARAM)length, (LPARAM)text);
	}
	...
	intptr_t ReplaceTargetRE(intptr_t length, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_REPLACETARGETRE, (WPARAM)length, (LPARAM)text);
	}

	/// Replace the target text with the argument text but ignore prefix and suffix that
	/// are the same as current.
	intptr_t ReplaceTargetMinimal(intptr_t length, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_REPLACETARGETMINIMAL, (WPARAM)length, (LPARAM)text);
	}

	/// Search for a counted string in the target and set the target to the found
	/// range. Text is counted so it can contain NULs.
	/// Returns start of found range or -1 for failure in which case target is not moved.
	intptr_t SearchInTarget(intptr_t length, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_SEARCHINTARGET, (WPARAM)length, (LPARAM)text);
	}
	...
	void CallTipShow(intptr_t pos, const char* definition) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t CallTipPosStart() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_CALLTIPPOSSTART, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t VisibleFromDocLine(intptr_t docLine) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_VISIBLEFROMDOCLINE, (WPARAM)docLine, (LPARAM)0);
	}

	/// Find the document line of a display line taking hidden lines into account.
	intptr_t DocLineFromVisible(intptr_t displayLine) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_DOCLINEFROMVISIBLE, (WPARAM)displayLine, (LPARAM)0);
	}

	/// The number of display lines needed to wrap a document line
	intptr_t WrapCount(intptr_t docLine) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_WRAPCOUNT, (WPARAM)docLine, (LPARAM)0);
	}
	...
	intptr_t GetLastChild(intptr_t line, int level) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETLASTCHILD, (WPARAM)line, (LPARAM)level);
	}

	/// Find the parent line of a child line.
	intptr_t GetFoldParent(intptr_t line) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETFOLDPARENT, (WPARAM)line, (LPARAM)0);
	}
	...
	void ToggleFoldShowText(intptr_t line, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t WordStartPosition(intptr_t pos, bool onlyWordCharacters) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_WORDSTARTPOSITION, (WPARAM)pos, (LPARAM)onlyWordCharacters);
	}

	/// Get position of end of word.
	intptr_t WordEndPosition(intptr_t pos, bool onlyWordCharacters) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_WORDENDPOSITION, (WPARAM)pos, (LPARAM)onlyWordCharacters);
	}
	...
	void AppendText(intptr_t length, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t LineLength(intptr_t line) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_LINELENGTH, (WPARAM)line, (LPARAM)0);
	}
	...
	intptr_t BraceMatch(intptr_t pos, int maxReStyle) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_BRACEMATCH, (WPARAM)pos, (LPARAM)maxReStyle);
	}
	...
	intptr_t BraceMatchNext(intptr_t pos, intptr_t startPos) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_BRACEMATCHNEXT, (WPARAM)pos, (LPARAM)startPos);
	}
	...
	intptr_t GetEdgeColumn() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETEDGECOLUMN, (WPARAM)0, (LPARAM)0);
	}
	...
	void MultiEdgeAddLine(intptr_t column, COLORREF edgeColour) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t GetMultiEdgeColumn(int which) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETMULTIEDGECOLUMN, (WPARAM)which, (LPARAM)0);
	}
	...
	intptr_t SearchNext(int searchFlags, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_SEARCHNEXT, (WPARAM)searchFlags, (LPARAM)text);
	}

	/// Find some text starting at the search anchor and moving backwards.
	/// Does not ensure the selection is visible.
	intptr_t SearchPrev(int searchFlags, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_SEARCHPREV, (WPARAM)searchFlags, (LPARAM)text);
	}

	/// Retrieves the number of lines completely visible.
	intptr_t LinesOnScreen() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_LINESONSCREEN, (WPARAM)0, (LPARAM)0);
	}
	...
	void* CreateDocument(intptr_t bytes, int documentOptions) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t PositionBefore(intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_POSITIONBEFORE, (WPARAM)pos, (LPARAM)0);
	}
	...
	intptr_t PositionAfter(intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_POSITIONAFTER, (WPARAM)pos, (LPARAM)0);
	}
	...
	intptr_t PositionRelative(intptr_t pos, intptr_t relative) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_POSITIONRELATIVE, (WPARAM)pos, (LPARAM)relative);
	}
	...
	intptr_t PositionRelativeCodeUnits(intptr_t pos, intptr_t relative) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_POSITIONRELATIVECODEUNITS, (WPARAM)pos, (LPARAM)relative);
	}
	...
	void CopyText(intptr_t length, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t GetLineSelStartPosition(intptr_t line) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETLINESELSTARTPOSITION, (WPARAM)line, (LPARAM)0);
	}

	/// Retrieve the position of the end of the selection at the given line (INVALID_POSITION if no selection on this line).
	intptr_t GetLineSelEndPosition(intptr_t line) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETLINESELENDPOSITION, (WPARAM)line, (LPARAM)0);
	}
	...
	intptr_t TargetAsUTF8(char* s) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_TARGETASUTF8, (WPARAM)0, (LPARAM)s);
	}
	...
	/// On error return 0.
	intptr_t EncodedFromUTF8(const char* utf8, char* encoded) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_ENCODEDFROMUTF8, (WPARAM)utf8, (LPARAM)encoded);
	}
	...
	intptr_t FindColumn(intptr_t line, intptr_t column) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_FINDCOLUMN, (WPARAM)line, (LPARAM)column);
	}
	...
	void ReplaceRectangular(intptr_t length, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t IndicatorStart(int indicator, intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_INDICATORSTART, (WPARAM)indicator, (LPARAM)pos);
	}

	/// Where does a particular indicator end?
	intptr_t IndicatorEnd(int indicator, intptr_t pos) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_INDICATOREND, (WPARAM)indicator, (LPARAM)pos);
	}
	...
	int GetCopySeparator(char* separator) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	void* GetRangePointer(intptr_t start, intptr_t lengthRange) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t GetGapPosition() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETGAPPOSITION, (WPARAM)0, (LPARAM)0);
	}
	...
	void MarginSetText(intptr_t line, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		::SendMessage(m_hWnd, SCI_MARGINSETTEXT, (WPARAM)line, (LPARAM)text);
	}

	/// Get the text in the text margin for a line
	int MarginGetText(intptr_t line, char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	void AnnotationSetText(intptr_t line, const char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
		::SendMessage(m_hWnd, SCI_ANNOTATIONSETTEXT, (WPARAM)line, (LPARAM)text);
	}

	/// Get the annotation text for a line
	int AnnotationGetText(intptr_t line, char* text) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t CharPositionFromPoint(int x, int y) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_CHARPOSITIONFROMPOINT, (WPARAM)x, (LPARAM)y);
	}
	...
	intptr_t CharPositionFromPointClose(int x, int y) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_CHARPOSITIONFROMPOINTCLOSE, (WPARAM)x, (LPARAM)y);
	}
	...
	intptr_t GetSelectionNCaret(int selection) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONNCARET, (WPARAM)selection, (LPARAM)0);
	}
	...
	intptr_t GetSelectionNAnchor(int selection) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONNANCHOR, (WPARAM)selection, (LPARAM)0);
	}
	...
	intptr_t GetSelectionNCaretVirtualSpace(int selection) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONNCARETVIRTUALSPACE, (WPARAM)selection, (LPARAM)0);
	}
	...
	intptr_t GetSelectionNAnchorVirtualSpace(int selection) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONNANCHORVIRTUALSPACE, (WPARAM)selection, (LPARAM)0);
	}
	...
	intptr_t GetSelectionNStart(int selection) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONNSTART, (WPARAM)selection, (LPARAM)0);
	}

	/// Returns the virtual space at the start of the selection.
	intptr_t GetSelectionNStartVirtualSpace(int selection) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONNSTARTVIRTUALSPACE, (WPARAM)selection, (LPARAM)0);
	}
	...
	intptr_t GetSelectionNEndVirtualSpace(int selection) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONNENDVIRTUALSPACE, (WPARAM)selection, (LPARAM)0);
	}

	/// Returns the position at the end of the selection.
	intptr_t GetSelectionNEnd(int selection) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETSELECTIONNEND, (WPARAM)selection, (LPARAM)0);
	}
	...
	intptr_t GetRectangularSelectionCaret() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETRECTANGULARSELECTIONCARET, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t GetRectangularSelectionAnchor() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETRECTANGULARSELECTIONANCHOR, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t GetRectangularSelectionCaretVirtualSpace() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETRECTANGULARSELECTIONCARETVIRTUALSPACE, (WPARAM)0, (LPARAM)0);
	}
	...
	intptr_t GetRectangularSelectionAnchorVirtualSpace() {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_GETRECTANGULARSELECTIONANCHORVIRTUALSPACE, (WPARAM)0, (LPARAM)0);
	}
	...
	int ChangeLexerState(intptr_t start, intptr_t end) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t ContractedFoldNext(intptr_t lineStart) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_CONTRACTEDFOLDNEXT, (WPARAM)lineStart, (LPARAM)0);
	}
	...
	/// Create an ILoader*.
	void* CreateLoader(intptr_t bytes, int documentOptions) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	void SetRepresentationAppearance(const char* encodedCharacter, int appearance) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	int GetRepresentationAppearance(const char* encodedCharacter) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	void SetRepresentationColour(const char* encodedCharacter, COLORREF colour) {
		ATLASSERT(::IsWindow(m_hWnd));
		::SendMessage(m_hWnd, SCI_SETREPRESENTATIONCOLOUR, (WPARAM)encodedCharacter, (LPARAM)colour);
	}

	/// Get the colour of a representation.
	COLORREF GetRepresentationColour(const char* encodedCharacter) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	int EOLAnnotationGetStyle(intptr_t line) {
		ATLASSERT(::IsWindow(m_hWnd));
	...
	intptr_t LineFromIndexPosition(intptr_t pos, int lineCharacterIndex) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_LINEFROMINDEXPOSITION, (WPARAM)pos, (LPARAM)lineCharacterIndex);
	}
	...
	intptr_t IndexPositionFromLine(intptr_t line, int lineCharacterIndex) {
		ATLASSERT(::IsWindow(m_hWnd));
		return (intptr_t)::SendMessage(m_hWnd, SCI_INDEXPOSITIONFROMLINE, (WPARAM)line, (LPARAM)lineCharacterIndex);
	}
